...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            Event(time=datetime.datetime(2019, 1, 12, 3, 53, 24, 866192, tzinfo=datetime.timezone.utc), log_type='DEBUG', logger_name='sharding-p', event_type=OperationLogs.LOG_RECEIVE_MSG, params=()),
        ),
    ),
    ids=(
        "addpeer format",
